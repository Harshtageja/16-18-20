...
<h1>Your Vehicle Number Plate</h1><br>
...
<form action="http://localhost/wannadrive6.php" method="post" enctype="multipart/form-data" name="image">
    ...
    <input class="v" type="file" name="image"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Upload License"><br><br><br><br>

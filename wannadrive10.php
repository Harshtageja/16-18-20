...
<form action="http://localhost/wannadrive11.php" method="post" enctype="multipart/form-data" name="image">
    ...
    <input class="v" type="text" name="Pickup"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="From..."><br><br>
    <label style="font-weight: bolder;margin-left: -3rem">To:</label>
    <input class="v" type="text" name="Destination"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Destination"><br><br><br><br>

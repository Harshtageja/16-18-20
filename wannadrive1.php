...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: right;background-color: black">
    <div class="navbar-nav" style="background-color: black">
      <a class="nav-link active " onclick="document.forms['status'].submit()" href="#" style="margin-left: 300px;" onMouseOver="this.style.color='yellow'"
...
<form action="http://localhost/wannadrive2.php" method="post" enctype="multipart/form-data" name="image">
    ...
    <input class="v" type="file" name="image"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Upload License"><br><br>
     <input class="v" type="text" name="LicenseNumber"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Your License Number"><br><br>
